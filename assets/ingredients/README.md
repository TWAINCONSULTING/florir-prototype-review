...
- ingen emoji, tekst, logo eller innbakt bakgrunn

Tekstvarianter kan dele samme bildenøkkel. Eksempel: `lettmelk`, `melk` og
`melk (evt. yoghurt)` kan alle bruke `milk.png`.
